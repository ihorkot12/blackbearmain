...
export const Button = ({ children, variant = 'primary', className = '', showIcon = true, ...props }: any) => {
  ...
  const baseStyles = "h-[58px] px-10 rounded-2xl font-bold uppercase tracking-[0.05em] transition-all duration-300 inline-flex items-center justify-center gap-3";
