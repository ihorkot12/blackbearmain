...
export const TeenLanding = () => {
  ...
  const painPoints = [
    ...
    },
    {
      ...
      title: "Фізична форма",
      desc: "Хочеться мати атлетичне тіло та бути сильнішим за однолітків? Наші тренування формують міцну та атлетичну статуру."
    },
    {
      ...
      <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            ...
            <h1 
              className="text-4xl sm:text-6xl md:text-[130px] font-black uppercase leading-[0.95] md:leading-[0.8] tracking-tight sm:tracking-tighter mb-10"
