...
const Encyclopedia = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-zinc-100 font-sans selection:bg-red-600 selection:text-white">
      <SEO 
        title={content?.encyclopedia_seo_title || PAGE_SEO['/encyclopedia'].title}
        description={content?.encyclopedia_seo_description || PAGE_SEO['/encyclopedia'].description}
        keywords={content?.encyclopedia_seo_keywords || PAGE_SEO['/encyclopedia'].keywords}
        image={PAGE_SEO['/encyclopedia'].image}
        imageAlt={PAGE_SEO['/encyclopedia'].imageAlt}
...
const NormativesSection = () => {
  ...
  const kyuData: any = {
    ...
    '9': {
      title: '9 КЮ — Помаранчевий пояс зі сріблястою смужкою',
    ...
    '7': {
      title: '7 КЮ — Синій пояс зі сріблястою смужкою',
    ...
    '5': {
      title: '5 КЮ — Жовтий пояс зі сріблястою смужкою',
    ...
    '3': {
      title: '3 КЮ — Зелений пояс зі сріблястою смужкою',
    ...
    '1': {
      title: '1 КЮ — Коричневий пояс зі сріблястою смужкою',
