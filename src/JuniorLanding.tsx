          ...
          >
            ...
            <div className="mt-12 flex items-center gap-8">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] uppercase tracking-widest text-zinc-500 font-bold">Призерів чемпіонатів</span>
              </div>
            </div>
          </motion.div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            <div className="relative order-2 lg:order-1">
              ...
              <div className="absolute bottom-12 -right-12 bg-red-600 p-8 rounded-[2rem] shadow-2xl hidden md:block">
                <div className="text-4xl font-black text-white leading-none mb-1">PRO</div>
                <div className="text-[10px] font-black uppercase tracking-widest text-white/80">Спортивний підхід</div>
              </div>
            </div>
            ...
            <div className="order-1 lg:order-2">
              ...
              <h3 className="text-4xl md:text-7xl font-black uppercase tracking-tighter mb-10 leading-[0.9]">
                Чому батьки <br /> обирають <span className="text-red-600">нас</span>
              </h3>
